...
*/
   ...
   */
   ...
   /**
   * This method gives the summary of a pet.
   * @return the summary.
   */
   ...
   /**
   * The method compares two pets by the owner name.
   * @return the value of compareTo.
   * @param petIn is the pet entered by the user.
   */
   public int compareTo(Pet petIn)
   {
      String lastName = "";
      String firstName = "";
      String[] names = petOwner.split("\\s");
      lastName = names[1];
      firstName = names[0];
      ...
      String lastNameIn = "";
      String firstNameIn = "";
      String[] namesIn = petIn.petOwner.split("\\s");
      lastNameIn = namesIn[1];
      firstNameIn = namesIn[0];
      String fullNameIn = lastNameIn + firstNameIn;
   
      return fullName.toLowerCase().compareTo(fullNameIn.toLowerCase());
   }
}