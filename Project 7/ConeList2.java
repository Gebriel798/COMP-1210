...
*/
   ...
   */
   ...
   /**
   * This method finds the cone with the smallest height in the array.
   * @return cone with the smallest height.
   */
   public Cone findConeWithSmallestHeight()
   {
      ...
      { 
         double min = tList[0].getHeight();
         result = tList[0];
         for (int i = 1; i < elements; i++)
         {
            if (tList[i].getHeight() < min)
            {
               min = tList[i].getHeight();
               result = tList[i];
            }
         }
      }  
   ...
   /**
   * This method finds the cone with the largest height.
   * @return cone with the largest height.
   */
   public Cone findConeWithLargestHeight()
   {
      ...
      { 
         double max = tList[0].getHeight();
         result = tList[0];
         for (int i = 1; i < elements; i++)
         {
            if (tList[i].getHeight() > max)
            {
               max = tList[i].getHeight();
               result = tList[i];
            }
         }
      }  
   ...
   /**
   * This method finds the cone with the smallest radius.
   * @return cone with the smallest radius.
   */
   public Cone findConeWithSmallestRadius()
   {
      ...
      { 
         double min = tList[0].getRadius();
         result = tList[0];
         for (int i = 1; i < elements; i++)
         {
            if (tList[i].getRadius() < min)
            {
               min = tList[i].getHeight();
               result = tList[i];
            }
   ...
   /**
   * This method finds the cone with the largest radius.
   * @return the cone with the largest radius.
   */
   public Cone findConeWithLargestRadius()
   {
      ...
      { 
         double max = tList[0].getRadius();
         result = tList[0];
         for (int i = 1; i < elements; i++)
         {
            if (tList[i].getRadius() > max)
            {
               max = tList[i].getRadius();
               result = tList[i];
            }
         }
      }  
