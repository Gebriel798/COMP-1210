...
*/
   ...
   */
   ...
   /**
   * This method resets the static field count.
   */
   ...
   /**
   * This method tests if an object is a cone.
   * @param obj is an object entered by the user.
   * @return true if object is a cone, false if it isnt.
   */
   ...
   /**
   * This method is a standard for checkstyle.
   * @return 0.
   */
   public int hashCode()
   {
